...
namespace LCUSharp.Websocket
{
    ...
    public interface ILeagueEventHandler
    {
        ...
        /// <summary>
        /// Unsubscribes the given event handler from the specified event uri.
        /// </summary>
        /// <param name="uri">The uri to unsubscribe from.</param>
        /// <param name="eventHandler">The event Handler to remove from the uri.</param>
        /// <returns>True if the uri exists, event handler was subscribed and was unsubscribed successfully, otherwise false.</returns>
        bool Unsubscribe(string uri,EventHandler<LeagueEvent> eventHandler);
